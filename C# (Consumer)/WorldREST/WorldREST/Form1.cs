...
namespace WorldREST
{
    ...
    public partial class Form1 : Form
    {
        ...
        private static bool schemaValid = false;
        ...
        public static CountryInfo GetCountryInfo(string type, string country)
        {
            ...
            CountryInfo sa = null;
            // API call
            var webRequest = WebRequest.Create("http://localhost:3001/api/v1/countries/" + country + "/" + type) as HttpWebRequest;
                ...
                using (var s = webRequest.GetResponse().GetResponseStream())
                {
                    using (var sr = new StreamReader(s))
                    {
                        ...
                        var dataObject = new
                        {
                            ...
                            data = File.ReadAllText(@"C:\Users\Hemran\REST\routes\json\draft-07.json")
                        };
            ...
            } else if (type == "xml" || type == "XML")
            {
                ...
                var webRequest2 = WebRequest.Create("http://localhost:3001/api/v1/countries/" + country + "/" + type) as HttpWebRequest;
                ...
                using (var s = webRequest2.GetResponse().GetResponseStream())
                {
                    using (var sr = new StreamReader(s))
                    {
                        ...
                        // Path to XML schema
                        xml.Schemas.Add(null, @"C:\Users\Hemran\REST\routes\xml\validate.xsd");
        ...
        public class CountryInfo
        {
            ...
            [XmlElement("Cities")]
            public List<CountryCities> Cities { get; set; }
